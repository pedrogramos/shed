...
void loop() { 
  ...
  if(dSonar[0] < dangerDistL && dSonar[0] != 0) danger.data=true;
  if(dSonar[1] < dangerDistF && dSonar[1] != 0) danger.data=true;
  if(dSonar[2] < dangerDistR && dSonar[2] != 0) danger.data=true;
