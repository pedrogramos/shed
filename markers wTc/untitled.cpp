...
int main(int argc, char **argv){
  ...
  */
  ...
  glm::mat4 M0,M0_0, M1,M2, M3;
  M0[0] = glm::vec4(0.0,0.0,-1.0,0.0);
  M0[1] = glm::vec4(0.0,1.0,0.0,0.0);
  M0[2] = glm::vec4(1.0,0.0,0.0,0.0);
  M0[3] = glm::vec4(0.0,0.0,800.0,1.0);

  
  
  M0_0[0] = glm::vec4(0.0,1.0,0.0,0.0);
  M0_0[1] = glm::vec4(0.0,0.0,1.0,0.0);
  M0_0[2] = glm::vec4(1.0,0.0,0.0,0.0);
  M0_0[3] = glm::vec4(0.0,0.0,800.0,1.0);


  M1[0] = glm::vec4(1.0,0.0,0.0,0.0);
  M1[1] = glm::vec4(0.0,0.0,1.0,0.0);
  M1[2] = glm::vec4(0.0,-1.0,0.0,0.0);
  M1[3] = glm::vec4(0.0,0.0,800.0,1.0);


  M2[0] = glm::vec4(0.0,-1.0,0.0,0.0);
  M2[1] = glm::vec4(0.0,0.0,1.0,0.0);
  M2[2] = glm::vec4(-1.0,0.0,0.0,0.0);
  M2[3] = glm::vec4(0.0,0.0,800.0,1.0);
  ...
  for(;;) {
   ...
   /*   rmpTm=rmpTc*cTm;
      ...
      */
      ...
      poseRMP.x = wTc[3][0];
      poseRMP.y = wTc[3][1];
      poseRMP.theta = atan2(wTc[0][1],wTc[0][0]);
